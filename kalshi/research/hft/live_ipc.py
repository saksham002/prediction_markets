...
queue and writes `orders.jsonl` / `decisions.jsonl` VERBATIM (it computes nothing
about them — all values are strategy-sourced). Kept dependency-free so importing
it in the sim/sweep path is free.
